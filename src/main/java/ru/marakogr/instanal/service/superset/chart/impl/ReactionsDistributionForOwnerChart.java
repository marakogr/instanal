...
@Component
public class ReactionsDistributionForOwnerChart extends AbstractChartProvider {

  protected ReactionsDistributionForOwnerChart(SupersetService supersetService) {
    super(supersetService);
  }

  @Override
  protected String description() {
    return "Distribution of reactions by type and owner";
  }
  ...
  protected String params(FriendRelation relation) {
    ...
    var reactionSender = owner.getName();
  ...
  protected String slice() {
    return "Distribution of reactions by owner";
  }
