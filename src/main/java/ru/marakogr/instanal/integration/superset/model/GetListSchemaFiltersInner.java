...
public class GetListSchemaFiltersInner {
  ...
  @javax.annotation.Nonnull private GetListSchemaFiltersInnerValue value;
  ...
  public GetListSchemaFiltersInner value(
      @javax.annotation.Nonnull GetListSchemaFiltersInnerValue value) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValue(@javax.annotation.Nonnull GetListSchemaFiltersInnerValue value) {
    this.value = value;
  }
